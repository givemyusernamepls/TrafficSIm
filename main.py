...
sim.roads[0].vehicles[0].append(
  Vehicle(I, sim, {"path": strecken_G + strecken_H[1:], "v_max": [G_speed_lim, H_speed_lim]})
)
sim.roads[2].vehicles[0].append(
  Vehicle(I, sim, {"path": strecken_K + strecken_H[1:], "v_max": [G_speed_lim, H_speed_lim]})
)
sim.roads[1].vehicles[0].append(
 Vehicle(I, sim, {"path": strecken_H, "v_max": [H_speed_lim, H_speed_lim]})
)
